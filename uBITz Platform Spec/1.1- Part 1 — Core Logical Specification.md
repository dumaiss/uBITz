...
| `/DMA_REQ`               | D→B         | Bus mastering request by device. Forwarded by Dock to Host.                                                                                                                                                                                                                                            |
| `/DMA_GNT`               | C→B         | Bus mastering acknowledgement by host. Forwarded by Dock to Devices while tri-stating the bus.                                                                                                                                                                                                         |

...
```
Class A — Media Tile (Artix-7 class FPGA + DDR3)
Class B — Versatile IO Tile (ESP32-S3 + iCE40 class FPGA)
```
...
# 3. Class A — Media Tile (Artix-7 class FPGA + DDR3)

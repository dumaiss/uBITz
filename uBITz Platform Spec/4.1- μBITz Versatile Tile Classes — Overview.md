# μBITz Versatile Tile Classes — Overview Specification
...
- **uBITz Host** — CPU Card
- **uBITz Bank** — Memory Card
- **uBITz Dock**— The backplane to connect it all
- **uBITz Tiles** — Peripheral devices that attach to the Dock bus
...
- Controllers (joystick/mouse/gamepad)
...
- CPU Tile orchestrates everything using register writes and interrupts
...
- ✓ Hand-solderable package (FGG256, 1mm pitch)
...
- Lattice ECP5: Good alternative but different toolchain
...
- ✓ Hand-solderable (96-ball FBGA, 0.8mm pitch)
...
[µBITz VDP Tile Specification v1.0](%C2%B5BITz%20VDP%20Tile%20Specification%20v1%200%202ae84f5aa5ee8032a123c3d11f3690e3.md)

[µBITz Sound Processor Tile Specification v1.0](%C2%B5BITz%20Sound%20Processor%20Tile%20Specification%20v1%200%202af84f5aa5ee80f5b952f745d3eb0671.md)
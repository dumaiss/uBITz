...
| ---- | ---------- | --------------- | ----- | --------- | ---------------------------------------------------------------------------------------------------------------------- |
| 1    | A          | B->D            | POWER | VCC_5V    | Main 5 V rail (slot power).                                                                                            |
| 1    | B          | D→B             | SENSE | /DRV5V    | Strap low only if the card may **drive 5V outputs** onto any shared bus/control line. Dock pull-up in AON.             |
| 2    | A          | B->D            | POWER | VCC_5V    | Main 5 V rail (slot power).                                                                                            |
| 2    | B          | B->D            | POWER | VCC_5V    | Main 5 V rail (slot power).                                                                                            |
| 3    | A          | B->D            | POWER | VCC_5V    | Main 5 V rail (slot power).                                                                                            |
| 3    | B          | B->D            | POWER | VCC_5V    | Main 5 V rail (slot power).                                                                                            |
| 4    | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 4    | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 5    | A          | B->D            | IO    | SLOT_SCL  | Enumeration I²C clock (open-drain, backplane master).                                                                  |
| 5    | B          | B->D            | IO    | /RESET    | Global system reset from backplane (active-low).                                                                       |
| 6    | A          | B↔D             | IO    | SLOT_SDA  | Enumeration I²C data (open-drain, bidirectional).                                                                      |
| 6    | B          | B->D            | IO    | /IORQ     | I/O cycle qualifier from backplane (active-low).                                                                       |
| 7    | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 7    | B          | B->D            | IO    | CLK_HOST  | Reference clock from Host (passed through Dock to Tiles).                                                              |
| 8    | A          | B->D            | POWER | VCC_3V3   | Main 3.3 V rail.                                                                                                       |
| 8    | B          | B->D            | IO    | CLK_DOCK0 | Reference clock 0 from Dock.                                                                                           |
| 9    | A          | B->D            | IO    | /CS       | Per-slot chip select from backplane (active-low).                                                                      |
| 9    | B          | B->D            | POWER | VCC_3V3   | Main 3.3 V rail.                                                                                                       |
| 10   | A          | B->D            | POWER | VCC_3V3   | Main 3.3 V rail.                                                                                                       |
| 10   | B          | B->D            | POWER | VCC_3V3   | Main 3.3 V rail.                                                                                                       |
| 11   | A          | B->D            | IO    | /INT_ACK  | Interrupt acknowledge from backplane to device (active-low).                                                           |
| 11   | B          | B->D            | IO    | R/W_      | Read/Write direction (1=READ, 0=WRITE).                                                                                |
| 12   | A          | B->D            | IO    | CLK_DOCK1 | Reference clock 1 from Dock.                                                                                           |
| 12   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 13   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 13   | B          | B->D            | IO    | CLK_DOCK2 | Reference clock 2 from Dock.                                                                                           |
| 14   | A          | B->D            | IO    | A[0]      | Address bit 0 (LSB).                                                                                                   |
| 14   | B          | B->D            | IO    | CLK_DOCK3 | Reference clock 3 from Dock.                                                                                           |
| 15   | A          | B->D            | IO    | A[1]      | Address bit 1.                                                                                                         |
| 15   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 16   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 16   | B          | B↔D             | IO    | D[0]      | Data bit 0 (LSB).                                                                                                      |
| 17   | A          | B->D            | IO    | A[2]      | Address bit 2.                                                                                                         |
| 17   | B          | B↔D             | IO    | D[1]      | Data bit 1.                                                                                                            |
| 18   | A          | D→B             | IO    | /DMA_REQ  | Bus-master request from device (active-low). (Reserved/ignored in v1 unless enabled later.) LEAVE NC UNTIL IMPLEMENTED |
| 18   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 19   | A          | B->D            | IO    | A[3]      | Address bit 3.                                                                                                         |
| 19   | B          | B↔D             | IO    | D[2]      | Data bit 2.                                                                                                            |
| 20   | A          | B->D            | IO    | A[4]      | Address bit 4.                                                                                                         |
| 20   | B          | B→D             | IO    | /DMA_GNT  | Bus-master grant to device (active-low). _(Reserved/ignored in v1 unless enabled later.)_. LEAVE NC UNTIL IMPLEMENTED  |
| 21   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 21   | B          | B↔D             | IO    | D[3]      | Data bit 3.                                                                                                            |
| 22   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 22   | B          | B↔D             | IO    | D[4]      | Data bit 4.                                                                                                            |
| 23   | A          | B->D            | IO    | A[5]      | Address bit 5.                                                                                                         |
| 23   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 24   | A          | B->D            | IO    | A[6]      | Address bit 6.                                                                                                         |
| 24   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 25   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 25   | B          | B↔D             | IO    | D[5]      | Data bit 5.                                                                                                            |
| 26   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 26   | B          | B↔D             | IO    | D[6]      | Data bit 6.                                                                                                            |
| 27   | A          | B->D            | IO    | A[7]      | Address bit 7.                                                                                                         |
| 27   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 28   | A          | B->D            | IO    | A[8]      | Address bit 8.                                                                                                         |
| 28   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 29   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 29   | B          | B↔D             | IO    | D[7]      | Data bit 7.                                                                                                            |
| 30   | A          | B->D            | IO    | A[9]      | Address bit 9.                                                                                                         |
| 30   | B          | B↔D             | IO    | D[8]      | Data bit 8.                                                                                                            |
| 31   | A          | B->D            | IO    | A[10]     | Address bit 10.                                                                                                        |
| 31   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 32   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 32   | B          | B↔D             | IO    | D[9]      | Data bit 9.                                                                                                            |
| 33   | A          | B->D            | IO    | A[11]     | Address bit 11.                                                                                                        |
| 33   | B          | B↔D             | IO    | D[10]     | Data bit 10.                                                                                                           |
| 34   | A          | B->D            | IO    | A[12]     | Address bit 12.                                                                                                        |
| 34   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 35   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 35   | B          | B↔D             | IO    | D[11]     | Data bit 11.                                                                                                           |
| 36   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 36   | B          | B↔D             | IO    | D[12]     | Data bit 12.                                                                                                           |
| 37   | A          | B->D            | IO    | A[13]     | Address bit 13.                                                                                                        |
| 37   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 38   | A          | B->D            | IO    | A[14]     | Address bit 14.                                                                                                        |
| 38   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 39   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 39   | B          | B↔D             | IO    | D[13]     | Data bit 13.                                                                                                           |
| 40   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 40   | B          | B↔D             | IO    | D[14]     | Data bit 14.                                                                                                           |
| 41   | A          | B->D            | IO    | A[15]     | Address bit 15.                                                                                                        |
| 41   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 42   | A          | B->D            | IO    | A[16]     | Address bit 16.                                                                                                        |
| 42   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 43   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 43   | B          | B↔D             | IO    | D[15]     | Data bit 15.                                                                                                           |
| 44   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 44   | B          | B↔D             | IO    | D[16]     | Data bit 16.                                                                                                           |
| 45   | A          | B->D            | IO    | A[17]     | Address bit 17.                                                                                                        |
| 45   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 46   | A          | B->D            | IO    | A[18]     | Address bit 18.                                                                                                        |
| 46   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 47   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 47   | B          | B↔D             | IO    | D[17]     | Data bit 17.                                                                                                           |
| 48   | A          | B->D            | IO    | A[19]     | Address bit 19.                                                                                                        |
| 48   | B          | B↔D             | IO    | D[18]     | Data bit 18.                                                                                                           |
| 49   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 49   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 50   | A          | B->D            | IO    | A[20]     | Address bit 20.                                                                                                        |
| 50   | B          | B↔D             | IO    | D[19]     | Data bit 19.                                                                                                           |
| 51   | A          | B->D            | IO    | A[21]     | Address bit 21.                                                                                                        |
| 51   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 52   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 52   | B          | B↔D             | IO    | D[20]     | Data bit 20.                                                                                                           |
| 53   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 53   | B          | B↔D             | IO    | D[21]     | Data bit 21.                                                                                                           |
| 54   | A          | B->D            | IO    | A[22]     | Address bit 22.                                                                                                        |
| 54   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 55   | A          | B->D            | IO    | A[23]     | Address bit 23.                                                                                                        |
| 55   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 56   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 56   | B          | B↔D             | IO    | D[22]     | Data bit 22.                                                                                                           |
| 57   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 57   | B          | B↔D             | IO    | D[23]     | Data bit 23.                                                                                                           |
| 58   | A          | B->D            | IO    | A[24]     | Address bit 24.                                                                                                        |
| 58   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 59   | A          | B->D            | IO    | A[25]     | Address bit 25.                                                                                                        |
| 59   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 60   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 60   | B          | B↔D             | IO    | D[24]     | Data bit 24.                                                                                                           |
| 61   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 61   | B          | B↔D             | IO    | D[25]     | Data bit 25.                                                                                                           |
| 62   | A          | B->D            | IO    | A[26]     | Address bit 26.                                                                                                        |
| 62   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 63   | A          | B->D            | IO    | A[27]     | Address bit 27.                                                                                                        |
| 63   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 64   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 64   | B          | B↔D             | IO    | D[26]     | Data bit 26.                                                                                                           |
| 65   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 65   | B          | B↔D             | IO    | D[27]     | Data bit 27.                                                                                                           |
| 66   | A          | B->D            | IO    | A[28]     | Address bit 28.                                                                                                        |
| 66   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 67   | A          | B->D            | IO    | A[29]     | Address bit 29.                                                                                                        |
| 67   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 68   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 68   | B          | B↔D             | IO    | D[28]     | Data bit 28.                                                                                                           |
| 69   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 69   | B          | B↔D             | IO    | D[29]     | Data bit 29.                                                                                                           |
| 70   | A          | B->D            | IO    | A[30]     | Address bit 30.                                                                                                        |
| 70   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 71   | A          | B->D            | IO    | A[31]     | Address bit 31 (MSB).                                                                                                  |
| 71   | B          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 72   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 72   | B          | B↔D             | IO    | D[30]     | Data bit 30.                                                                                                           |
| 73   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 73   | B          | B↔D             | IO    | D[31]     | Data bit 31 (MSB).                                                                                                     |
| 74   | A          | B->D            | IO    | /MREQ     | Memory request qualifier (active-low).                                                                                 |
| 74   | B          | D->B            | IO    | /CPU_ACK  | Host → backplane acknowledge for vectored interrupt/IntAck-mode style cycles (active-low).                             |
| 75   | A          | B->D            | IO    | /MEM0_CS  | Bit 1 of memory region select.                                                                                         |
| 75   | B          | B->D            | IO    | /CPU_INT0 | Backplane → Host interrupt input 0.                                                                                    |
| 76   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 76   | B          | D->B            | IO    | /READY    | Device wait-state indication to backplane (active-low).                                                                |
| 77   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 77   | B          | D->B            | IO    | /INT_CH0  | Maskable interrupt channel 0 from device.                                                                              |
| 78   | A          | B->D            | IO    | /MEM1_CS  | Bit 2 of memory region select.                                                                                         |
| 78   | B          | B->D            | IO    | /CPU_INT1 | Backplane → Host interrupt input 1.                                                                                    |
| 79   | A          | D->B            | IO    | /CPU_INT2 | Backplane → Host interrupt input 2 (active-low).                                                                       |
| 79   | B          | B->D            | IO    | /CPU_NMI0 | Backplane → Host NMI input 0                                                                                           |
| 80   | A          | B->D            | GND   | GND       | Ground.                                                                                                                |
| 80   | B          | D->B            | IO    | /INT_CH1  | Maskable interrupt channel 1 from device.                                                                              |
| 81   | A          | B->D            | IO    | /CPU_INT3 | CPU Interrupt Line 3                                                                                                   |
| 81   | B          | D->B            | IO    | /NMI_CH   | Non-maskable interrupt channel from device.                                                                            |
| 82   | A          | B->D            | IO    | /CPU_NMI1 | Backplane → Host NMI input 1 (active-low).                                                                             |
| 82   | B          | D->B            | SENSE | /SENS3V   | Strap low only if the card is **3.3V-only / not 5V-tolerant**. Dock pull-up in AON.                                    |
...
* Keep trace lengths and loading within typical PCIe x16 mechanical
  recommendations (solid reference planes, controlled impedance) B though

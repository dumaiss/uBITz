...
| 18   | odd             | D→B             | IO    | /DMA_REQ  | Bus-master request from device (active-low). _(Reserved/ignored in v1 unless enabled later.)               |
| 18   | even            | B->D            | GND   | GND       | Ground.                                                                                                    |
| 19   | odd             | B->D            | IO    | A[3]      | Address bit 3.                                                                                             |
| 19   | even            | B↔D             | IO    | D[2]      | Data bit 2.                                                                                                |
| 20   | odd             | B->D            | IO    | A[4]      | Address bit 4.                                                                                             |
| 20   | even            | B→D             | IO    | /DMA_GNT  | Bus-master grant to device (active-low). _(Reserved/ignored in v1 unless enabled later.)_.                 |
